...
poema+= 'Que mesmo am face do amor encanto\n'
poema+= 'Dele se encante mais meu pensamento\n'
poema+= 'Queo vive-lo em cada vão momento\n'
...
poema+= 'E assim quanto mais tarde me procure\n'
...
poema+= 'Que não seja imortal, porto que é chama\n'
